...
/**
 * Return span element containing error message in function of value in param
 * @param {String} value text from main search bar
 * @returns {HTMLElement}
 */
export const displayErrorMessage = value => {
  const message = `« Aucune recette ne contient ‘${value}’ vous pouvez chercher « tarte aux pommes », « poisson », etc.`
