...
import {
  ...
  dropdownUstensils, ustensilsSearchBar, dropdownUstensilsCollapsed
...
dropdownIngredients.addEventListener('click', () => {
  ...
  dropdownIngredientsCollapsed.style.display = dropdownIngredients.classList.contains('down') ? 'block' : 'none'
...
dropdownDevices.addEventListener('click', () => {
  ...
  dropdownDevicesCollapsed.style.display = dropdownDevices.classList.contains('down') ? 'block' : 'none'
...
dropdownUstensils.addEventListener('click', () => {
  ...
  dropdownUstensilsCollapsed.style.display = dropdownUstensils.classList.contains('down') ? 'block' : 'none'
...
const applyCategorySearch = category => {
  ...
  createItem(data, categoryToDisplay)
}
